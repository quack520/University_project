<template>
    ...
    <div class="message">
        <div class="body" v-for="(pet) in pets" :key="pet.id">
            <router-link to="/frequency" style="text-decoration:none" @click="frequency(pet.pet_num)">
                <div class="text">
                    <div class="lef">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            fetchData() {
                axios.get('/api/php/questionlist.php',{
                    params:{
                        rebonse_num:localStorage.getItem('token')
                    }
                })
                .then(res => {
                    this.pets = res.data;
